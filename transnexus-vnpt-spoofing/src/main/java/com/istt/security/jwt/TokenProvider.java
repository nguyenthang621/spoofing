...
public class TokenProvider {
	...
	public TokenProvider(JHipsterProperties jHipsterProperties) {
		...
		if (!ObjectUtils.isEmpty(secret)) {
			...
			if (jHipsterProperties.getSecurity().getAuthentication().getJwt().getBase64Secret() == null) {
				System.out.println("test1: " + jHipsterProperties.getSecurity());
				System.out.println("test2: " + jHipsterProperties.getSecurity().getAuthentication());
				System.out.println("test3: " + jHipsterProperties.getSecurity().getAuthentication().getJwt());
				System.out.println(
						"test4: " + jHipsterProperties.getSecurity().getAuthentication().getJwt().getSecret());
