...
//	Redisson redisson;
	...
	public void handleTxn(long invokeId, int status) {
		System.out.println("-----------countDown cache------------");
//		redisson.getCountDownLatch(Constants.TXN + invokeId).countDown();
	...
	@Override
	public void onDialogProviderAbort(MAPDialog dlg, MAPAbortProviderReason abortProviderReason,
			MAPAbortSource abortSource, MAPExtensionContainer extensionContainer) {
		log.debug("onDialogProviderAbort: dialog {} reason {} source {} container {}", dlg, abortProviderReason,
				abortSource, extensionContainer);
		handleTxn(dlg.getLocalDialogId(), 5);
	}

	@Override
	public void onDialogReject(MAPDialog dlg, MAPRefuseReason refuseReason,
			ApplicationContextName alternativeApplicationContext, MAPExtensionContainer extensionContainer) {
		String uData = "refuseReason=" + refuseReason + ", alternativeApplicationContext="
				+ alternativeApplicationContext + ", dlgId=" + dlg.getLocalDialogId();
	...
	@Override
	public void onDialogUserAbort(MAPDialog dlg, MAPUserAbortChoice userReason,
