...
public class Sms implements Serializable {
  ...
  /**
   * schedule_delivery_time smpp parameter time when SMSC should start a delivery (may be null �
  ...
  /**
   * The validity period of this message (if ESME have not defined or for MO messages this field is
   * filled by default SMSC settings)
   */
  ...
  //    }
  //
  //    public void setMessageDeliveryResultResponse(MessageDeliveryResultResponseInterface
  ...
  public boolean isMcDeliveryReceipt() {
    if ((this.esmClass & ESME_DELIVERY_ACK) != 0) return true;
    else return false;
  }
  ...
  @Override
  public int hashCode() {
    if (dbId != null) return dbId.hashCode();
    else return 0;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (this.dbId == null || other.dbId == null) return false;
    if (this.dbId.equals(other.dbId)) return true;
    else return false;
  }
